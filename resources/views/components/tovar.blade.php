@props(['id', 'date', 'title', 'description', 'price', 'img', 'edit', 'delete', 'in_stock' => false])
<div class="flex flex-col bg-[#1C1D1F] w-[361px] items-start px-[30px] py-[40px] gap-[20px]">
    ...
    <div class="flex flex-col">
        ...
        @if($in_stock && (!isset($edit) || !isset($delete)))
        ...
        @elseif(!isset($edit) || !isset($delete))
            <p class="mt-[15px] text-red-500">К сожалению, товар закончился</p>
        @endif
